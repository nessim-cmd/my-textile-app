...
export default function ExportDetailPage() {
  ...
  useEffect(() => {
    ...
    const ht = exporte.lines.reduce((acc, { quantity, unitPrice }) => 
      acc + (quantity || 0) * (unitPrice || 0), 0
    )
      ...
      <div>
        ...
        <div className='flex flex-col md:flex-row w-full'>
          <div className='flex w-full md:w-1/3 flex-col'>
            ...
            <ExportInfo exporte={exporte} setExports={setExporte} />
          </div>

          <div className='flex w-full md:w-2/3 flex-col md:ml-4'>
            <ExportLines exporte={exporte} setExports={setExporte} />
