      ...
      <div>
        <div className='flex flex-col md:flex-row md:justify-between md:items-center mb-4'>
          <p className='badge badge-ghost badge-lg uppercase'>
            <span>Livraison-</span>{livraison.id}
          </p>
        ...
        <div className='flex flex-col md:flex-row w-full'>
          <div className='flex w-full md:w-1/3 flex-col'>
            <LivraisonInfo livraison={livraison} setLivraison={setLivraison} />
          </div>

          <div className='flex w-full md:w-2/3 flex-col md:ml-4'>
            <LivraisonLines livraison={livraison} setLivraison={setLivraison} />
