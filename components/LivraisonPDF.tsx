...
const LivraisonPDF: React.FC<{ livraison: Livraison }> = ({ livraison }) => {
                ...
                <div className='p-8' ref={livraisonRef}>
                    ...
                    <div className='my-4 flex justify-between'>
                        ...
                        <div className='text-right'>
                            ...
                            <p className='text-sm text-gray-500 w-52 break-words'>{livraison.clientAddress}</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4 p-2 border border-gray-300 rounded-lg shadow-md text-sm mt-4">
                        <div className="flex flex-col space-y-1">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span>{formatDate(livraison.soumissionValable)}</span>
                            </div>
                        </div>
                    </div>
                </div>
