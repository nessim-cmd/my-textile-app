...
export const updateUserRole = async (clerkUserId: string, role: Role, name?: string) => {
  try {
    const updateData: { role: Role; name?: string } = { role };
    if (name) updateData.name = name; // Allow name update
